...
class Authorization(Resource):
    def get(self):
        ...
        access_token = data['access_token']
        return redirect('http://ec2-54-175-153-92.compute-1.amazonaws.com:5000/quickbooks?status=success&message=ok&access_token=%s&realmId=%s'%(access_token, realmId),code=302)
