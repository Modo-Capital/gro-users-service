...
class Input(db.Model):
    ...
    emp_length = db.Column(db.Integer, nullable=True, default=0)
    annual_income = db.Column(db.Integer, nullable=True, default=0)
    average_current_balance = db.Column(db.Float, nullable=True, default=0)
    percentBcGt75 = db.Column(db.Float, nullable=True, default=0)
    bcUtil = db.Column(db.Float, nullable=True, default=0)
    openAcc = db.Column(db.Integer, nullable=True, default=0)
    totalBalExMort = db.Column(db.Float, nullable=True, default=0)
    revolBal = db.Column(db.Float, nullable=True, default=0)
    revolUtil = db.Column(db.Float, nullable=True, default=0)
    totalBcLimit = db.Column(db.Float, nullable=True,default=0)
    totalAcc = db.Column(db.Integer, nullable=True,default=0)
    totalIlHighCreditLimit = db.Column(db.Float, nullable=True, default=0)
    numRevAccts = db.Column(db.Float, nullable=True, default=0)
    totHiCredLim = db.Column(db.Float, nullable=True, default=0)
    totCurBal = db.Column(db.Float, nullable=True, default=0)
    numBcTl = db.Column(db.Integer, nullable=True, default=0)
    numIlTl = db.Column(db.Integer, nullable=True, default=0)
    dtiJoint = db.Column(db.Float, nullable=True, default=0)
    totalBalIl = db.Column(db.Integer, nullable=True, default=0)
    iLUtil = db.Column(db.Float, nullable=True, default=0)
    mtgPayment = db.Column(db.Float, nullable=True,default=0)
